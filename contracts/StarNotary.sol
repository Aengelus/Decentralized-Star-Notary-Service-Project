...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == ownerOf(_tokenId1) || msg.sender == ownerOf(_tokenId2) , "Not an owner of the token.");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerOf(_tokenId), 'Message sender has to be the owner of the token.');
